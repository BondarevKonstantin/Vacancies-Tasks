const pokemons = {
  cards: [
    ...
    },
    {
      ...
      resistances: [{ type: "Psychic", value: "-20" }],
      weaknesses: [{ type: "Fighting", value: "+10" }],
    },
    {
      id: "dp1-3",
      name: "Electivire",
    ...
    },
    {
      ...
      imageUrl: "https://images.pokemontcg.io/swsh4/186.png",
      imageUrlHiRes: "https://images.pokemontcg.io/swsh4/186_hires.png",
      types: ["Grass"],
      supertype: "Pokémon",
      subtype: "VMAX",
      ...
      ability: {
        name: "Eerie Beam",
        text:
          "Once during your turn, if this Pokémon is in the Active Spot, you may put 1 damage counter on each of your opponent's Pokémon.",
        type: "Ability",
      },
      hp: "310",
      retreatCost: ["Colorless"],
